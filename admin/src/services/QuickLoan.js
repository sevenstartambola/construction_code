...
const getLoanList = async (data) => {
    ...
    getQuickLoanSubMenu = async (data, id) => {
        ...
        // console.log(token);
        try {
            let result = await opsService.postData(id > 0 ?
    ...
    getApplicationNo = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `LMS/getAppNo_AND_LoanNo`,
                data,
                token
            );
            return result;
    ...
    getBranchHeadByBranch = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `LMS/GetBranchHeadByBranch`,
                data,
                token
            );
            return result;
    ...
    getSourceName = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `LOS/Get_PartnerForDropdown`,
                data,
                token
            );
            return result;
    ...
    getEmployeeDropdown = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `Masters/GetEmployeeDropdown`,
                data,
                token
            );
            return result;
    ...
    getCollectionExecutive = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `LMS/GetCollectionExecutive`,
                data,
                token
            );
            return result;
    ...
    submitDemographicDetails = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `LOS/Save_CustomerInfo`,
                data,
                token
            );
            return result;
    ...
    submitCustomerDetails = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `LMS/SaveCustomerInfoDetails`,
                data,
                token
            );
            return result;
    ...
    getOccupationList = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `LMS/LMS_Commaon_Master`,
                data,
                token
            );
            return result;
    ...
    getLoanSummary = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `LMS/LMS_Get_Loan_Summary`,
                data,
                token
            );
            return result;
    ...
    getLoanReferance = async (data) => {
        ...
        try {
            let result = await opsService.postData(
                base_url + `LMS/LMS_GetCustomerRef`,
                data,
                token
            );
            return result;
