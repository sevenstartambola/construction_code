...
const BookTicket = React.lazy(() => import("./views/tickets/BookTicket"))
const AgentTransaction = React.lazy(() => import("./views/transaction/AgentTransaction"))
...
const routes = [
  ...
  { path: "/agentTransaction", name: "Ticket", element: AgentTransaction },
